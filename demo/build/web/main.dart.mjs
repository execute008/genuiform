...
class CompiledApp {
  ...
  async instantiate(additionalImports,
    ...
    const dart2wasm = {
      ...
      _1281: () => globalThis.window.navigator.userAgent,
      _1287: (x0,x1) => x0.createElement(x1),
      _1293: (x0,x1,x2) => x0.addEventListener(x1,x2),
      _1294: x0 => x0.load(),
      _1295: x0 => x0.play(),
      _1296: x0 => x0.pause(),
      _1300: (x0,x1) => x0.removeAttribute(x1),
      _1302: (x0,x1) => x0.start(x1),
      _1303: (x0,x1) => x0.end(x1),
      ...
      _1320: () => new AudioContext(),
      _1321: (x0,x1) => x0.createMediaElementSource(x1),
      _1322: x0 => x0.createStereoPanner(),
      _1323: (x0,x1) => x0.connect(x1),
      _1324: x0 => x0.disconnect(),
      _1325: x0 => x0.remove(),
      _1326: x0 => x0.resume(),
      _1327: x0 => x0.close(),
      ...
      _1331: Date.now,
      _1333: s => new Date(s * 1000).getTimezoneOffset() * 60,
      _1334: s => {
      ...
      _1335: () => new Error().stack,
      _1336: () => typeof dartUseDateNowForTicks !== "undefined",
      _1337: () => 1000 * performance.now(),
      _1338: () => Date.now(),
      _1339: () => {
      ...
      _1341: () => new WeakMap(),
      _1342: (map, o) => map.get(o),
      _1343: (map, o, v) => map.set(o, v),
      _1344: (exn) => exn.toString(),
      _1345: (exn) => exn.stack,
      _1346: (exn) => {
      ...
      _1347: x0 => new WeakRef(x0),
      _1348: x0 => x0.deref(),
      _1355: () => globalThis.WeakRef,
      _1359: s => JSON.stringify(s),
      _1360: s => printToConsole(s),
      _1361: (o, p, r) => o.replaceAll(p, () => r),
      _1362: (o, p, r) => o.replace(p, () => r),
      ...
      _1407: x0 => new Array(x0),
      _1409: x0 => x0.length,
      _1411: (x0,x1) => x0[x1],
      _1412: (x0,x1,x2) => { x0[x1] = x2 },
      _1415: (x0,x1,x2) => new DataView(x0,x1,x2),
      _1417: x0 => new Int8Array(x0),
      _1418: (x0,x1,x2) => new Uint8Array(x0,x1,x2),
      _1420: x0 => new Uint8ClampedArray(x0),
      _1422: x0 => new Int16Array(x0),
      _1424: x0 => new Uint16Array(x0),
      _1426: x0 => new Int32Array(x0),
      _1428: x0 => new Uint32Array(x0),
      _1430: x0 => new Float32Array(x0),
      _1432: x0 => new Float64Array(x0),
      _1456: x0 => x0.random(),
      _1457: (x0,x1) => x0.getRandomValues(x1),
      _1458: () => globalThis.crypto,
      _1459: () => globalThis.Math,
      _1461: () => globalThis.performance,
      _1462: () => globalThis.JSON,
      _1463: x0 => x0.measure,
      _1464: x0 => x0.mark,
      _1465: x0 => x0.clearMeasures,
      _1466: x0 => x0.clearMarks,
      _1467: (x0,x1,x2,x3) => x0.measure(x1,x2,x3),
      _1468: (x0,x1,x2) => x0.mark(x1,x2),
      _1469: x0 => x0.clearMeasures(),
      _1470: x0 => x0.clearMarks(),
      _1471: (x0,x1) => x0.parse(x1),
      _1472: (ms, c) =>
      ...
      _1494: o => o.length,
      _1496: (o, i) => o[i],
      _1497: f => f.dartFunction,
      _1498: () => ({}),
      _1499: () => [],
      _1501: () => globalThis,
      _1502: (constructor, args) => {
      ...
      _1504: (o, p) => o[p],
      _1505: (o, p, v) => o[p] = v,
      _1506: (o, m, a) => o[m].apply(o, a),
      _1508: o => String(o),
      _1509: (p, s, f) => p.then(s, (e) => f(e, e === undefined)),
      _1510: (module,f) => finalizeWrapper(f, function(x0) { return module.exports._1510(f,arguments.length,x0) }),
      _1511: (module,f) => finalizeWrapper(f, function(x0,x1) { return module.exports._1511(f,arguments.length,x0,x1) }),
      _1512: o => {
      ...
      _1513: o => [o],
      _1514: (o0, o1) => [o0, o1],
      _1515: (o0, o1, o2) => [o0, o1, o2],
      _1516: (o0, o1, o2, o3) => [o0, o1, o2, o3],
      ...
      _1585: x0 => x0.cancel(),
      _1586: x0 => x0.read(),
      _1590: (x0,x1) => x0.key(x1),
      _1591: o => o instanceof Array,
      _1592: (a, i) => a.push(i),
      _1596: a => a.pop(),
      _1597: (a, i) => a.splice(i, 1),
      _1598: (a, s) => a.join(s),
      _1599: (a, s, e) => a.slice(s, e),
      _1601: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1602: a => a.length,
      _1604: (a, i) => a[i],
      _1605: (a, i, v) => a[i] = v,
      _1607: o => {
      ...
      _1608: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1610: o => o instanceof Uint8Array,
      _1611: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1612: o => o instanceof Int8Array,
      _1613: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1614: o => o instanceof Uint8ClampedArray,
      _1615: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1616: o => o instanceof Uint16Array,
      _1617: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1618: o => o instanceof Int16Array,
      _1619: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1620: o => o instanceof Uint32Array,
      _1621: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1622: o => o instanceof Int32Array,
      _1623: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1625: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1626: o => o instanceof Float32Array,
      _1627: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1628: o => o instanceof Float64Array,
      _1629: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1630: (t, s) => t.set(s),
      _1631: l => new DataView(new ArrayBuffer(l)),
      _1632: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1634: o => o.buffer,
      _1635: o => o.byteOffset,
      _1636: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1637: (b, o) => new DataView(b, o),
      _1638: (b, o, l) => new DataView(b, o, l),
      _1639: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1640: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1641: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1642: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1643: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1644: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1645: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1646: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1647: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1648: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1649: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1650: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1653: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1654: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1655: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1656: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1657: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1658: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1659: Function.prototype.call.bind(Number.prototype.toString),
      _1660: Function.prototype.call.bind(BigInt.prototype.toString),
      _1661: Function.prototype.call.bind(Number.prototype.toString),
      _1662: (d, digits) => d.toFixed(digits),
      _1665: (d, precision) => d.toPrecision(precision),
      _1675: () => globalThis.document,
      _1681: (x0,x1) => { x0.height = x1 },
      _1683: (x0,x1) => { x0.width = x1 },
      _1685: (x0,x1) => { x0.pointerEvents = x1 },
      _1694: x0 => x0.style,
      _1697: x0 => x0.src,
      _1698: (x0,x1) => { x0.src = x1 },
      _1699: x0 => x0.naturalWidth,
      _1700: x0 => x0.naturalHeight,
      _1716: x0 => x0.status,
      _1717: (x0,x1) => { x0.responseType = x1 },
      _1719: x0 => x0.response,
      _1849: x0 => x0.style,
      _2421: x0 => x0.videoWidth,
      _2422: x0 => x0.videoHeight,
      _2426: (x0,x1) => { x0.playsInline = x1 },
      _2452: x0 => x0.error,
      _2454: (x0,x1) => { x0.src = x1 },
      _2459: (x0,x1) => { x0.crossOrigin = x1 },
      _2462: (x0,x1) => { x0.preload = x1 },
      _2463: x0 => x0.buffered,
      _2466: x0 => x0.currentTime,
      _2467: (x0,x1) => { x0.currentTime = x1 },
      _2468: x0 => x0.duration,
      _2473: (x0,x1) => { x0.playbackRate = x1 },
      _2480: (x0,x1) => { x0.autoplay = x1 },
      _2482: (x0,x1) => { x0.loop = x1 },
      _2484: (x0,x1) => { x0.controls = x1 },
      _2486: (x0,x1) => { x0.volume = x1 },
      _2488: (x0,x1) => { x0.muted = x1 },
      _2503: x0 => x0.code,
      _2504: x0 => x0.message,
      _2577: x0 => x0.length,
      ...
      _4052: x0 => x0.data,
      _4146: (x0,x1) => { x0.onmessage = x1 },
      _4157: (x0,x1) => { x0.onmessage = x1 },
      _4205: x0 => x0.length,
      _5593: x0 => x0.destination,
      _5597: x0 => x0.state,
      _6146: x0 => x0.signal,
      _6218: () => globalThis.document,
      _6633: (x0,x1) => { x0.id = x1 },
      _7979: x0 => x0.value,
      _7981: x0 => x0.done,
      _8679: x0 => x0.url,
      _8681: x0 => x0.status,
      _8683: x0 => x0.statusText,
      _8684: x0 => x0.headers,
      _8685: x0 => x0.body,
      _10813: (x0,x1) => { x0.border = x1 },
      _11255: (x0,x1) => { x0.height = x1 },
      _11945: (x0,x1) => { x0.width = x1 },
      _12313: x0 => x0.name,
      _12314: x0 => x0.message,
